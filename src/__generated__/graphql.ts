...
export type Class = {
  ...
  combinedSectionId: Scalars['String']['output'];
  component?: Maybe<Scalars['String']['output']>;
  course: Course;
  enrollmentCap?: Maybe<Scalars['Int']['output']>;
  enrollmentTotal: Scalars['Int']['output'];
  equivalents: Scalars['String']['output'];
  instructionType: Scalars['String']['output'];
  ...
  reserveCapacities: Array<ClassReserveCapacity>;
...
export type ClassReserveCapacity = {
  __typename?: 'ClassReserveCapacity';
  description: Scalars['String']['output'];
  enrollCap: Scalars['Int']['output'];
  enrollTotal: Scalars['Int']['output'];
...
export type GetClassSchedulesQuery = { __typename?: 'Query', classes: Array<{ __typename?: 'Class', classNumber: number, schedules: Array<{ __typename?: 'ClassSchedule', days: string, startTime?: number | null, endTime?: number | null }> }> };
...
export type GetScheduleDisplayClassesQuery = { __typename?: 'Query', classes: Array<{ __typename?: 'Class', classNumber: number, classSection: string, title: string, units: string, course: { __typename?: 'Course', code: string }, schedules: Array<{ __typename?: 'ClassSchedule', building?: string | null, room?: string | null, days: string, startTime?: number | null, endTime?: number | null, instructors: Array<{ __typename?: 'Instructor', name: string }> }> }> };

export type GetFullScheduleDisplayClassesQueryVariables = Exact<{
  class_numbers: Array<Scalars['Int']['input']> | Scalars['Int']['input'];
  term: Scalars['String']['input'];
}>;


export type GetFullScheduleDisplayClassesQuery = { __typename?: 'Query', classes: Array<{ __typename?: 'Class', classNumber: number, classSection: string, component?: string | null, meetingDates?: string | null, instructionType: string, title: string, enrollmentTotal: number, enrollmentCap?: number | null, waitlistTotal?: number | null, waitlistCap?: number | null, units: string, lastUpdatedAt: any, course: { __typename?: 'Course', code: string, description?: string | null }, schedules: Array<{ __typename?: 'ClassSchedule', building?: string | null, room?: string | null, days: string, startTime?: number | null, endTime?: number | null, instructors: Array<{ __typename?: 'Instructor', name: string }> }> }> };
...
export type GetClassesQuery = { __typename?: 'Query', classes: Array<{ __typename?: 'Class', term: string, classNumber: number, classSection: string, title: string, enrollmentTotal: number, enrollmentCap?: number | null, units: string, lastUpdatedAt: any, course: { __typename?: 'Course', code: string, description?: string | null }, schedules: Array<{ __typename?: 'ClassSchedule', building?: string | null, room?: string | null, days: string, startTime?: number | null, endTime?: number | null, instructors: Array<{ __typename?: 'Instructor', name: string }> }> }> };
...
export const GetFullScheduleDisplayClassesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetFullScheduleDisplayClasses"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"class_numbers"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"term"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"classes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"classNumbers"},"value":{"kind":"Variable","name":{"kind":"Name","value":"class_numbers"}}},{"kind":"Argument","name":{"kind":"Name","value":"term"},"value":{"kind":"Variable","name":{"kind":"Name","value":"term"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"classNumber"}},{"kind":"Field","name":{"kind":"Name","value":"course"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}},{"kind":"Field","name":{"kind":"Name","value":"classSection"}},{"kind":"Field","name":{"kind":"Name","value":"component"}},{"kind":"Field","name":{"kind":"Name","value":"meetingDates"}},{"kind":"Field","name":{"kind":"Name","value":"instructionType"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"schedules"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"building"}},{"kind":"Field","name":{"kind":"Name","value":"room"}},{"kind":"Field","name":{"kind":"Name","value":"instructors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"days"}},{"kind":"Field","name":{"kind":"Name","value":"startTime"}},{"kind":"Field","name":{"kind":"Name","value":"endTime"}}]}},{"kind":"Field","name":{"kind":"Name","value":"enrollmentTotal"}},{"kind":"Field","name":{"kind":"Name","value":"enrollmentCap"}},{"kind":"Field","name":{"kind":"Name","value":"waitlistTotal"}},{"kind":"Field","name":{"kind":"Name","value":"waitlistCap"}},{"kind":"Field","name":{"kind":"Name","value":"units"}},{"kind":"Field","name":{"kind":"Name","value":"lastUpdatedAt"}}]}}]}}]} as unknown as DocumentNode<GetFullScheduleDisplayClassesQuery, GetFullScheduleDisplayClassesQueryVariables>;
