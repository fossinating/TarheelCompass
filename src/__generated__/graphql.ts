...
export type GetFullScheduleDisplayClassesQuery = { __typename?: 'Query', classes: Array<{ __typename?: 'Class', classNumber: number, classSection: string, title: string, enrollmentTotal: number, enrollmentCap?: number | null, units: string, lastUpdatedAt: any, course: { __typename?: 'Course', code: string, description?: string | null }, schedules: Array<{ __typename?: 'ClassSchedule', building?: string | null, room?: string | null, days: string, startTime?: number | null, endTime?: number | null, instructors: Array<{ __typename?: 'Instructor', name: string }> }> }> };
