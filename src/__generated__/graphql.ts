...
export type GetCachedClassesQueryVariables = Exact<{
  term: Scalars['String']['input'];
  numbers?: InputMaybe<Array<Scalars['Int']['input']> | Scalars['Int']['input']>;
}>;


export type GetCachedClassesQuery = { __typename?: 'Query', classes: Array<{ __typename?: 'Class', classNumber: number, classSection: string, combinedSectionId?: string | null, component?: string | null, enrollmentCap?: number | null, enrollmentTotal?: number | null, equivalents?: string | null, hours: number, instructionType?: string | null, meetingDates?: string | null, term: string, waitlistCap?: number | null, waitlistTotal?: number | null, course: { __typename?: 'Course', code: string, credits: string, description?: string | null, title: string, attrs: Array<{ __typename?: 'CourseAttribute', label: string, value: string }> }, schedules: Array<{ __typename?: 'ClassSchedule', days: string, endTime: number, startTime: number, location: string, instructors: Array<{ __typename?: 'Instructor', instructorType: string, name: string }> }> }> };
