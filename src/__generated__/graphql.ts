...
export type ClassesQueryVariables = Exact<{
  classNumbers: Array<Scalars['Int']['input']> | Scalars['Int']['input'];
  term: Scalars['String']['input'];
}>;


export type ClassesQuery = { __typename?: 'Query', classes: Array<{ __typename?: 'Class', classNumber: number, schedules: Array<{ __typename?: 'ClassSchedule', days: string, startTime: number, endTime: number }> }> };
