...
export type GetFullScheduleDisplayClassesQuery = { __typename?: 'Query', classes: Array<{ __typename?: 'Class', classNumber: number, classSection: string, title: string, enrollmentTotal?: number | null, enrollmentCap?: number | null, hours: number, lastUpdatedAt: any, course: { __typename?: 'Course', code: string, description?: string | null }, schedules: Array<{ __typename?: 'ClassSchedule', location: string, days: string, startTime: number, endTime: number, instructors: Array<{ __typename?: 'Instructor', name: string }> }> }> };
